...
async def start(event):
  await event.reply("**Sohbet Salonu Tagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
...
print(">> Bot çalıyor merak etme 🚀 @Tctimbotsupport 'dan bilgi ve yardım alabilirsin <<")
